...
To record audio using `go-sdl2`, you will need to create a Go function exported as C function. That function will be passed to SDL2 so it can call the function when there is new audio data.
